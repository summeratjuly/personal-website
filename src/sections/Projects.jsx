...
const projects = [
  ...
  {
    title: 'Onboard Extract',
    description: 'Tooling for extracting and organizing onboarding information into a cleaner, reusable workflow.',
    tech: ['Python', 'Data Extraction', 'Automation'],
    image: null,
    github: 'https://github.com/summeratjuly/onboard-extract',
    live: null,
  },
  {
    title: 'F1 Highlights',
    description: 'Tooling for collecting and organizing Formula 1 highlight clips into an easier review workflow.',
    tech: ['Python', 'Video Processing', 'Automation'],
    image: null,
    github: 'https://github.com/summeratjuly/f1-highlights',
    live: null,
  },
  {
    title: 'dev-annotate',
